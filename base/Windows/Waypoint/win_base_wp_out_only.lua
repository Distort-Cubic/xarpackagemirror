...
function p.__render(wid)
    ...
    local msg = "YOU CAN TRAVEL FROM THIS LOCATION, BUT NOT BACK TO IT"
    ga_win_txt_center(wid, 0.95, msg)

    ga_win_set_front_color_default(wid)
    ga_win_set_char_size(wid, 0.02, 0.04)
    msg = "SELECT A WAYPOINT TO TRAVEL TO"
    ga_win_txt_center(wid, 0.9, msg)

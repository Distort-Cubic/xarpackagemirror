...
function p.teleport(target_handle)
    game_base_wp_system.teleport_target_only(target_handle)
    --
    local source_path = win_base_wp.get_cur_path()
    win_base_wp_temp1.set_temp_wp_path(source_path)
end

...
function p.__render(wid)
    ...
    ga_win_txt_center(wid, 0.85, "AGONY MODE")
    ...
    ga_win_txt_center(wid, 0.80, "DAMAGE TO ENEMIES: 66%")
    ga_win_txt_center(wid, 0.75, "DAMAGE FROM ENEMIES: 100%") --Accurate.

    ga_win_quad(wid, 0.35, 0.3, 0.65, 0.7, "icon_hard_2")
end

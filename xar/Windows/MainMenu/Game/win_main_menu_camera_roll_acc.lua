--win_main_menu_camera_roll_acc.lua

function p.def_value()
    return 0.01000 --Default num.
end
...
function p.__render(wid)
    ...
    ga_win_txt_center(wid, 0.85, "ROLL ACCELERATION")

    ga_win_set_char_size(wid, 0.02, 0.04)
    ga_win_txt_center(wid, 0.75, "DEFAULT VALUE: 0.01")
    ga_win_txt_center(wid, 0.7, "NEVER HAVE THIS < 0.0")

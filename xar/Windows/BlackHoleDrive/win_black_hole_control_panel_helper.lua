...
function p.__render(wid)
    ...
    local radius = game_black_hole_drive.get_alt_radius()
    ...
    ga_win_txt_center(wid, 0.3, "USING THE BLACK HOLE DRIVE")
    ...
    ga_win_txt_center(wid, 0.21, "A RADIUS OF 2 REQUIRES CHEATING TO BE ENABLED")
end
...
function p.increment_radius()
    local old_radius = game_black_hole_drive.get_alt_radius()
    ...
    game_black_hole_drive.set_alt_radius(new_radius)
end
